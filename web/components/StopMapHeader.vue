<template>
  <div class="relative w-full overflow-hidden" style="height: 220px; background: var(--bg-secondary)">
    ...
    <!-- Expand — geo: URI works on both iOS (opens Maps) and Android (opens preferred maps app) -->
    <a
      v-if="lat && lng"
      ...
      style="width: 36px; height: 36px; background: rgba(255,255,255,0.88); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); box-shadow: 0 1px 6px rgba(0,0,0,0.18); color: #1a1a1a"
    >
