...
@IBDesignable
open class MarqueeLabel: UILabel, @preconcurrency CAAnimationDelegate {
...
public struct EdgeFade: OptionSet, Sendable {
    public let rawValue: Int
    nonisolated(unsafe) public static let leading = EdgeFade(rawValue: 1 << 0)
    nonisolated(unsafe) public static let trailing = EdgeFade(rawValue: 1 << 1)
